                               ...
                               Content Details
                                 ...
                                 if(isset($_GET['sno'])){
                                         //get the value
                                             ...
                                             {
                                                 echo "Detalis Already Exist";
                                             }
                                             else{
                            //execute the query
                            $sql="UPDATE dailydiary SET sno=$no,workdate='$date',diarycontent='$dcont',image='$img',ctype='$ctype',class='$class',section='$section' where sno=$no";
                            if($conn->query($sql))
                            {
