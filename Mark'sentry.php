       ...
       if(!isset($_SESSION['UNAME']))
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                 ...
                 <!--TABLE, PANEL, ACCORDION AND MODAL  -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <form name="myfrom" action="EntryMark's.php" enctype="multipart/form-data">
                            <table class="table">
                            <tr>
                                <th>Test
                                <td><select name="test">
                                    ...
                                    <option>HalfYearly Test</option>
                                    <option>Yearly Test</option>
    </select></th>
                            </tr>
                            <tr>
                                <th>Classe
               ...
               <p align="right"><input type="submit" value="Search"></p></tr>
    </form>
                            </table>
                            </div>
