                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th>EnRollNo</th><th>ExamName</th><th>Date</th><th>Total</th><th>MarkObt</th><th>Percentage</th></tr>
                                        <?php
                                        ...
                                        //execute the query
                                        $sql="select * from examrecord where examname='$ename' and dot='$formatdate'";
                                        $result=$conn->query($sql);
                                        //list the record
                                        while($row=$result->fetch_assoc())
                                        {
                                            echo "<tr class=success>";
                                            echo "<th>".$row['enrollno']."</th>";
                                            echo "<th>".$row['examname']."</th>";
                                            echo "<Th>$formatdate</th>";
                                            echo "<Th>".$row['total']."</th>";
                                            echo "<th>".$row['markobt']."</th>";
