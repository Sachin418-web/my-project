            ...
            <div class="inner" style="min-height: 700px;">
                ...
                <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            include "dbconnect.php";
                            //execute the query
                            $sql="UPDATE studentmaster SET sno='$no',enrollno='$enr',sname='$sname',class='$class',section='$section',fname='$fname',mname='$mname',addresss='$add',phone='$phone',emailid='$eid' where sno='$no'";
                            if($conn->query($sql))
                            {
