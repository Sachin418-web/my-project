                 ...
                 <!--TABLE, PANEL, ACCORDION AND MODAL  -->
                                        ...
                                        <thead>
                                            <script lang="javascript">
                                                function show()
                                                {
                                                    ...
                                                    //send the url
                                                    ob.open("GET","Showclass_Ajax.php?n="+id,true);
                                                    ob.send();
                                                }
                                                </script>
                                        <tr>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <form name="mform" action="class.php" method="GET" enctype="multipart/form-data"> 
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="class" placeholder="Class" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="subject" placeholder="Subject's" class="form-control" />
                                            </div>
                                        </div>
