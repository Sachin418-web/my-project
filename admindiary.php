                                    ...
                                    <table class="table">
                                        ...
                                        <script lang="javascript">
                                                function show()
                                                {
                                                    ...
                                                    //send the url
                                                    ob.open("GET","Showdairy_Ajax.php?n="+id,true);
                                                    ob.send();
                                                }
                                                </script>
                                            <tr>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            <form name="mform" action="dairy.php" enctype="multipart/form-data">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="date" placeholder="Date" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                 <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <textarea id="text1" name="dcont" cols="77"></textarea>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <textarea id="text1" name="ctype" cols="77"></textarea>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="class" placeholder="Subject's" class="form-control" />
                                            </div>
                                        </div>
                                        </div>
                            <div class="panel-body">
