            ...
            <div class="inner" style="min-height: 700px;">
                                    ...
                                    <table class="table">
                                        ...
                                        <script lang="javascript">
                                                function show()
                                                {
                                                    ...
                                                    //send the url
                                                    ob.open("GET","ShowExam_Ajax.php?n="+id,true);
                                                    ob.send();
                                                }
                                                </script>
                                        <tr>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                            <form name="mform" action="examR.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="text1" class="control-label col-lg-4">Sno</label>

                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="sno" placeholder="Serial No." class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" name="ename" placeholder="Exam Name" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="Date" id="text1" name="date" placeholder="Date" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="Total" placeholder="Total Marks" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                 <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="marks" placeholder="Maximum Marks" class="form-control" />
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="per" placeholder="Percentage" class="form-control" />
                                            </div>
                                        </div>
                            </div>
