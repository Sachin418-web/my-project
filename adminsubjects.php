            ...
            <div class="inner" style="min-height: 700px;">
                                    ...
                                    <table class="table">
                                        ...
                                        <script lang="javascript">
                                                function show()
                                                {
                                                    ...
                                                    //send the url
                                                    ob.open("GET","ShowSubject_Ajax.php?n="+id,true);
                                                    ob.send();
                                                }
                                                </script>
                                        <tr>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <form name="mform" action="subject.php" enctype="multipart/form-data">
                            <div class="panel-body">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="scode" placeholder="Subject Code" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                 <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="sname" placeholder="Subject Name" class="form-control" />
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                                        <div class="form-group">
                                            <label for="text1" class="control-label col-lg-4">Controls</label>

                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="cont" placeholder="Controls" class="form-control" readonly/>
                                            </div>
                                        </div>
                                        </div>
