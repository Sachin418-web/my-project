                ...
                <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            //execute the query
                                        ...
                                        $sql="select *from dailydiary where workdate='$date'";
                                        $result=$conn->query($sql);
                                        //list the reords
                                        if($row=$result->fetch_assoc())
                                        {
                                        echo "<p align=center>Detalis Already Exist</p>";
                                        }
                                        else 
                                        {
                                        $sql_insert="INSERT INTO dailydiary (sno,workdate,diarycontent,image,ctype,class,section) values('$sno','$date','$dcont','$img','$ctype','$class','$opt')";
                                        if($conn->query($sql_insert)){
                                        echo "<p align=center><h2>Record Added Susscsfully</h2></p>";}
                                        else 
                                            echo "error";
                                        }
                                ?>                       
