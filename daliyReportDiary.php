       ...
       if(!isset($_SESSION['UNAME']))
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        <h1> Daily Diary Content Report's</h1>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               <p align=center> Fill the Diary Content Detalis</p>
                            </div>
                            <div class="panel-body">
                                ...
                                <?php
                                   ...
                                   //excute the query
                                   $sql="select * from dailydiary where class='$class' and section='$section' and workdate='$formattedDate'";
                                   
                                   $result=$conn->query($sql);
                                    echo "<table class=table>";
                                    echo "<tr><Th>Class</th><th>Section</th><th>Workdate</th>";
                                  
                                    echo "<th>DiaryContent</th><th>image</th><th>ctype</th></tr>";
                                   //list the record
                        ...
                        <!--this fro the right side section-->
                    </div>
