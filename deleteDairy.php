            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                 ...
                 <!--TABLE, PANEL, ACCORDION AND MODAL  -->
                    ...
                    <form name="mform" action="Dairy_Delete.php" enctype="multipart/form-data">
                    ...
                    <?php
                            //get the value
                                $sno=$_GET['sno'];         
                                            include "dbconnect.php";
                                            //execute the query
                                            $sql="select *from dailydiary where sno='$sno'";
                                            $result=$conn->query($sql);
                                            //list the record
                                            while($row=$result->fetch_assoc())
                                            {
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="date" value="<?php echo $row['workdate'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                 <div class="form-group">
                                            <label  for="text1" class="control-label col-lg-4">Diary Contant</label>
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="dcont" value="<?php echo $row['diarycontent'];?>" class="form-control" readonly></input>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                                 <div class="form-group">
                                            <label  for="text1" class="control-label col-lg-4">Images</label>
                                            <div class="col-lg-8">
                                 ...
                                 <div class="panel-body">
                                 <div class="form-group">
                                            <label  for="text1" class="control-label col-lg-4">Contant Type</label>
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="ctype" value="<?php echo $row['ctype'];?>" class="form-control" readonly></input>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="section" value="<?php echo $row['section'];?>" class="form-control" readonly/>
                                           </div>
                                        </div>
                            </div>
