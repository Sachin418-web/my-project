            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                 ...
                 <!--TABLE, PANEL, ACCORDION AND MODAL  -->
                    ...
                    <form name="mform" action="ExamType_Delete.php" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="scode" value="<?php echo $row['examname'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="sname" value="<?php echo $row['maxmarks'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
