       ...
       if(!isset($_SESSION['UNAME']))
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                ...
                <form name="mform" action="student_delete.php" method="POST" enctype="multipart/form-data">   
                <?php
                            //get the value
                                ...
                                $sno=$_GET['sno'];         
                                            include "dbconnect.php";
                                            //execute the query
                                            $sql="select *from studentmaster where sno='$sno'";
                                            $result=$conn->query($sql);
                                            //list the record
                                            while($row=$result->fetch_assoc())
                                            {
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="sno" value="<?php echo $row['sno'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="eno" value="<?php echo $row['enrollno'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">  
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" name="sname" value="<?php echo $row['sname'];?>" class="form-control" readonly/>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">  
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" name="class" value="<?php echo $row['class'];?>" class="form-control" readonly/>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="class" value="<?php echo $row['section'];?>" class="form-control" readonly/>
                                        </div>
                                    </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="fname" value="<?php echo $row['fname'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="mname" value="<?php echo $row['mname'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                 <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="add" value="<?php echo $row['addresss'];?>" class="form-control" readonly/>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="phone" value="<?php echo $row['phone'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="email" id="text1" name="email-id" value="<?php echo $row['emailid'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                                        <p align=right><input type=submit Value=Delete style=margin-top:10px;display:flexbox;margin-right:12px;border-radius:5px;-background-Color:lightblue;><input type=reset value=Reset style=margin-top:10px;display:flexbox;margin-right:12px;border-radius:5px;-background-Color:lightblue;>
                                        </form>   
                        </div>  
                    </div>
<?php
