            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                 ...
                 <!--TABLE, PANEL, ACCORDION AND MODAL  -->
                    ...
                    <form name="mform" action="subjectdelete.php" method="POST" enctype="multipart/form-data"> 
                    ...
                    <?php
                            //get the value
                                $sno=$_GET['sno'];         
                                            include "dbconnect.php";
                                            //execute the query
                                            $sql="select *from subjectmaster where sno='$sno'";
                                            $result=$conn->query($sql);
                                            //list the record
                                            while($row=$result->fetch_assoc())
                                            {
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="scode" value="<?php echo $row['subjectcode'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="sname" value="<?php echo $row['subjectname'];?>" class="form-control" readonly/>
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
