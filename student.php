        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                ...
                <div class="col-lg-12">
                    ...
                    include "dbconnect.php";
                    // Execute the query
                    $sql = "SELECT * FROM studentmaster WHERE enrollno='$enr'";
                    $result = $conn->query($sql);
                    // List the records
                    if ($result->fetch_assoc() > 0)    
                    {
                    echo "<p align=center>Details Already Exist</p>";
                    } 
                    else 
                    {
                    $sql_insert = "INSERT INTO studentmaster (sno, enrollno, name, class, section, fname, mname, address, phone, emailid, password, image) 
                    VALUES ('$sno', '$enr', '$sname', '$class', '$ch', '$fname', '$mname', '$add', '$Phone', '$email', '$password', '$image')";
                    if ($conn->query($sql_insert)) 
                    {
                    echo "<p align=center><h2>Record Added Successfully</h2></p>";
                     }                       
                            else 
                            {
                            echo "error";
