            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                 ...
                 <!--TABLE, PANEL, ACCORDION AND MODAL  -->
                    ...
                    <form name="mform" action="Dairy_update.php" enctype="multipart/form-data">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="date" value="<?php echo $row['workdate'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                 <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="dcont" value="<?php echo $row['diarycontent'];?>" class="form-control" ></input>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                                 <div class="form-group">
                                            ...
                                            <input type="file" id="text1" name="img" cols="40"></input>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                                 <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="ctype" value="<?php echo $row['ctype'];?>" class="form-control" ></input>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="section" value="<?php echo $row['section'];?>" class="form-control" />
                                           </div>
                                        </div>
                            </div>
