            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                 ...
                 <!--TABLE, PANEL, ACCORDION AND MODAL  -->
                    ...
                    <form name="mform" action="classupdate.php" method="get" enctype="multipart/form-data"> 
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="subject" value="<?php echo $row['stream']; ?>" class="form-control" />
                                            </div>
                                        </div>
