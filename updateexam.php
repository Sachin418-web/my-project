       ...
       if(!isset($_SESSION['UNAME']))
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                ...
                <form name="mform" action="Exam_Update.php" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="date" value="<?php echo $row['dot'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="Total" value="<?php echo $row['total'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                 <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="marks" value="<?php echo $row['markobt'];?>" class="form-control" />
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="per" value="<?php echo $row['percentage'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
