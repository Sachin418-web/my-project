       ...
       if(!isset($_SESSION['UNAME']))
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                ...
                <form name="mform" action="Student_update.php" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="eno" value="<?php echo $row['enrollno'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">  
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" name="sname" value="<?php echo $row['sname'];?>" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">  
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" name="class" value="<?php echo $row['class'];?>" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="sect" value="<?php echo $row['section'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="fname" value="<?php echo $row['fname'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="mname" value="<?php echo $row['mname'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                 <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="add" value="<?php echo $row['addresss'];?>" class="form-control" />
                                        </div>
                                    </div>
                                 </div>
                                 <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="phone" value="<?php echo $row['phone'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="email" id="text1" name="email-id" value="<?php echo $row['emailid'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
