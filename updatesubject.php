            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                 ...
                 <!--TABLE, PANEL, ACCORDION AND MODAL  -->
                    ...
                    <form name="mform" action="subjectupdate.php" method="get" enctype="multipart/form-data"> 
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" id="text1" name="scode" value="<?php echo $row['subjectcode'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                            <input type="text" id="text1" name="sname" value="<?php echo $row['subjectname'];?>" class="form-control" />
                                            </div>
                                        </div>
                            </div>
                            <div class="panel-body">
